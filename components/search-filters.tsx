...
export default function SearchFilters() {
  ...
  return (
    <div className="flex flex-col gap-6 p-4 bg-white border rounded-2xl shadow-sm">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        
        {/* 🔍 Search input */}
        <div className="space-y-2">
          <Label htmlFor="search" className="text-xl font-medium text-gray-900">Search</Label>
          <Input
            id="search"
        ...
        {/* 📂 Event Type filter */}
        <div className="space-y-2">
          <Label className="text-xl font-medium text-gray-900">Event Type</Label>
          <div className="flex flex-wrap gap-3">
            {eventTypes.map(eventType => (
              <div key={eventType} className="flex items-center gap-2">
                ...
                />
                <Label htmlFor={`event-type-${eventType}`} className="text-xl text-gray-800 cursor-pointer">
                  {eventType}
                </Label>
              </div>
            ))}
        ...
        {/* 📅 Date Range filter */}
        <div className="space-y-2">
          <Label className="text-xl font-medium text-gray-900">Date Range</Label>
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className={cn(
                    "w-full justify-start text-left rounded-lg font-normal text-xl",
      ...
      <div>
        <Button
          ...
          variant="outline"
          className="gap-2 rounded-lg border-gray-300 hover:bg-gray-100"
        >
          <FilterX className="h-5 w-4 text-xl text-gray-900 " />
          Reset Filters
        </Button>
      </div>
    </div>
